...
if __name__ == "__main__":
    ...
    queries_df = pd.read_csv("data/extracted/dev.csv")
    ...
    with open("data/processed/l2r_test.txt", "w") as f:
        f.write(test_txt)

    with open("data/processed/l2r_train.txt", "w") as f:
        f.write(train_txt)
