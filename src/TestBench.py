...
def vsm_WikiQA(dataset_name, test_csv_path, passages_path, max_results):
    ...
    test_results_file = (
        PROCESSED_DATA_DIR + "/vsm_test_results_" + dataset_name + ".csv"
    )
...
if __name__ == "__main__":
    ...
    # ql
    tester_wikiqa = TestMetrics_WikiQA(testpath_wikiqa)
    ...
    # ql
    tester_webap = TestMetrics_WebAP(test_csv_path)
